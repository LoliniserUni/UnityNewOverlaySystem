...
var blueTeamLogo = document.getElementById("blueLogo");
var blueTeamScore = document.getElementById("blueScore");

var orangeTeamName = document.getElementById("orangeTeamName");
var orangeTeamLogo = document.getElementById("orangeLogo");
var orangeTeamScore = document.getElementById("orangeScore");
...
function updateSlider(val1, val2, element) {
    ...
    var elem = document.getElementById(element + "Skew");
...
function updatePlayer(player, pos, col) {
    // Update DOM
    document.getElementById(col + "Player" + pos).textContent = player.name;
    document.getElementById(col + "Score" + pos).textContent = player.score;
    document.getElementById(col + "Goals" + pos).textContent = player.goals;
    document.getElementById(col + "Assists" + pos).textContent = player.assists;
    document.getElementById(col + "Shots" + pos).textContent = player.shots;
    document.getElementById(col + "Saves" + pos).textContent = player.saves;
    document.getElementById(col + "Touches" + pos).textContent = player.touches;
    document.getElementById(col + "Demos" + pos).textContent = player.demos;
